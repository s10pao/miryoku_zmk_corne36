...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_LMT_GA(LGUI, A), U_LMT_GA(LALT, R), U_LMT_CS(LCTRL, S),U_LMT_CS(LSHFT, T),&kp G,             &kp M,             U_RMT_CS(LSHFT, N),U_RMT_CS(LCTRL, E),U_RMT_GA(LALT, I), U_RMT_GA(LGUI, O), \
U_LT(U_BUTTON, Z), U_LMT_GA(RALT, X), &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_RMT_GA(RALT, DOT),U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
